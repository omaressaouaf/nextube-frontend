        ...
        <div className="video-description flex items-start flex-wrap md:flex-nowrap  justify-between">
          <div className="flex items-start order-2 md:order-1">
            ...
            <div className="text-sm mt-1">
              ...
              <div className="mt-5">
                <p className="mb-4">
                  Get Started with React.js and learn how to build amazing websites with ReactJS! Full Project included, 100% free! Join our bestselling ReactJS course: https://acad.link/reactjs Join our Academind Community on Discord: https://academind.com/community Check out all our other courses:
